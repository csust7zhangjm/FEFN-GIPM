...
parser.add_argument('--dataset', default='GOT-10k', type=str,
        help='datasets')
...
def main():
    ...
    dataset_root = '/root/autodl-tmp/full_data/test' #Absolute path of the dataset
    net_path = '/root/autodl-tmp/hyf_save_eps/checkpoints/ltr/transt/transt/TransT_ep0100.pth.tar' #Absolute path of the model
