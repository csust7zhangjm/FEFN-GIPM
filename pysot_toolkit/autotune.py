...
parser.add_argument('--window_penalty', default='', type=float)
...
def main():
    ...
    dataset_root = '/root/autodl-tmp/OTB100' #Absolute path of the dataset
    net_path = '/root/autodl-tmp/checkpoints/TransT_ep0998.pth.tar' #Absolute path of the model

    # create model
    net = NetWithBackbone(net_path=net_path, use_gpu=True)
    tracker = Tracker(name='transt', net=net, window_penalty=args.window_penalty, exemplar_size=128, instance_size=256)
